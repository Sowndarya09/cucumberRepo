...
public class ViewClaimDetailsFromHome extends Driver {
	...
	public ViewClaimDetailsFromHome()
	{
...
//		Driver.getPgDriver().switchTo().frame(this.Iframeelement);
	...
	@FindBy(xpath="//span[@data-test-id='20160208012641035648291']")
	...
	{
		utils.validatetablerowbasedonvalues(tblITSSpecificDetails, itsspecificdetails);
	...
	public boolean verifyAccumulatorDetails(String[] accumulatorvalues)
	{
		...
		System.out.println("Accumulator Link Clicked");
	...
	public boolean switchWindow(String[] sUrl)
	{
		...
		utils.clickAnelemnt(lnkProcessingDetailsClaimText, "ViewClaimDetails", "Claim Edit Link");
		utils.TabHandles(sUrl[0]);
	...
	//Sprint 1.3
		...
		{
			return utils.selectValueFromListbyVisibleString(drpDownOtherActions, "View Remit", "View Claim Details", "View Remit");
		}
		...
		public boolean verifyHoverTextInPaidAs(String[] hovermessage)
		{
			...
			{
				return utils.selectValueFromListbyVisibleString(drpDownOtherActions, "View/Send EOB", "View Claim Details", "View Remit");
			}
			...
			public boolean clickrdBtnClaimDiscussed()
			{
				utils.waitforpageload();
				 if(utils.clickAnelemnt(this.rdBtnClaimDiscussed , "Manage claims", "Radio button Claim Discussed"))
					 if(utils.clickAnelemnt(this.btnSubmit, "View Claims", "Submit Button"))
						 return true;
				 return false;
			}
		 ...
		 public boolean validateLineDetailsAndClickTheRow(String[] tablevalues) throws InterruptedException
		 {
			...
			public boolean verifyDisplayOfViewAuthPopUp(){
				...
				if(!utils.isProxyWebelement(viewAuthorizationAlertHeader))
					if(utils.isvalueMatch_contain(actaulMsg, empMsg))
						return true;
				return false;
			}
			...
			@FindBy(xpath="//input[@id='ClaimAdjustable'][@checked]")
