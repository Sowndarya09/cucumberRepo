...
public class ManageAuthorizationReview {
	...
	public ManageAuthorizationReview()
	{
	...
	public boolean clickOtherActionsRequestManagerHelp(){
		if(utils.clickAnelemnt(this.btnOtherActions, "ManageAuthorizationReview", "Other Actions button"))
			if(utils.clickAnelemnt(this.lnkOtherReqMgrHelp, "ManageAuthorizationReview", "Request Manager Help"))
				return utils.validateHeader(this.sHeaderManageAuthorizationReview,"Request Manager/OE Help");
			return false;
	}
	...
	WebElement labelItemsReviewedDuringManageAuthorization;
	...
	{
		try{
			this.labelItemsReviewedDuringManageAuthorization.click();
			WebElement row =utils.getProviderResultsBasedOnValues(this.AuthorizationDiscussedTable,args);
	...
	/**This method clicks on Other Actions and selects Request Manager Help is not present
	 * 
	 * @return
	 */
	public boolean validateRequestManagerHelpIsNotPresent() {
		if(utils.clickAnelemnt(btnOtherActions, "Manage Authorization Review", "btnOtherActions"))
