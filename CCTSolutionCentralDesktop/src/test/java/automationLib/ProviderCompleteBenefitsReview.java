...
public class ProviderCompleteBenefitsReview extends Driver {
	
	SeleniumUtilities utils=new SeleniumUtilities();
	ErrorLogger err = new ErrorLogger();
	public ProviderCompleteBenefitsReview() throws IOException
	{
	...
	public boolean navigatetoRequestManagerHelp()
	{
		if(utils.clickAnelemnt(this.btnOtherActions, "Billing Review", "Other Actions button"))
			if(utils.clickAnelemnt(this.lnkOthrActionsRequestManagerHelp, "Request Manager Help", "Links"))
				return true;
			return false;
	}
	...
	public boolean navigatetoAccessDocuments()
	{
		if(utils.clickAnelemnt(this.btnOtherActions, "Billing Review", "Other Actions button"))
			if(utils.clickAnelemnt(this.btnOtherActions, "Billing Review", "Other Actions button"))
				if(utils.clickAnelemnt(this.lnkOthrActionsAccessDocuments, "Access Documents", "Links"))
				return true;
			return false;
	}
	...
	public boolean RequestBenefitVerficationSubmit()
	{
		if(utils.clickAnelemnt(this.drpdwnReasonforRequest, "Samp", "Samp"))
			if(utils.selectDropDownbyVisibleString(this.drpdwnReasonforRequest, "Request Benefit Verification", "Complete Benefits Review ", "Request Benefit Verification-option"))
				if(utils.clickAnelemnt(this.btnSubmit, "Request Benefit Verification", "Submit button"))
						return true;
		return false;
	...
	public boolean expandDiscalimerQuotedWithContact()
	{
