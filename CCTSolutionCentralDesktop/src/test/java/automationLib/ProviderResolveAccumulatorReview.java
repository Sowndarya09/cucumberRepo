...
public class ProviderResolveAccumulatorReview {
	...
	public ProviderResolveAccumulatorReview(){
		try
		{
	...
	public boolean verifyResolveAccReviewPage(){   
		return utils.validateHeader(this.resolveAccReviewLbl, "Resolve Accumulator Review");
	}
	...
	public boolean validateMemberAndFamilyLevelAccumHeaders(String[] args){
		...
		return (utils.validateTableRowHeader(getMemberlevelTable(), colHdrs)) && (utils.validateTableRowHeader(getFamilylevelTable(), colHdrs));
	}
	...
	public boolean validateBenefitLevelAccumHeaders(String[] args){
		...
		return utils.validateTableRowHeader(this.benefitLevelAccumList, colHdrs);
	}
	/*
	 * @SCU
	...
	public boolean validateMemLevelAccList(String[] args) throws InterruptedException{
		return utils.clickontablerowbasedonvalues(getMemberlevelTable(),args);
	}
	...
	public boolean validateFamilyLevelAccList(String[] args) throws InterruptedException{
		return utils.clickontablerowbasedonvalues(getFamilylevelTable(),args);
	}
	...
	public boolean validateBenefitLevelAccList(String[] args) throws InterruptedException{
		return utils.clickontablerowbasedonvalues(this.benefitLevelAccumList,args);
	}
	...
	/**This functionality selects Requested in error from Accums Team Response drop down, Enter some text in Notes and SUbmit at Resolve Accumulators Review Page
	 * 
	 * @return
	 */
	public boolean selectRequestedInErrorAndEnterNotesAsTestAndSubmit() {
		if(utils.selectDropDownbyVisibleString(this.drpDownAccumsResponse,"Requested in Error", "ResolveAccumulatorReview", "Accums Response drop down"))
			if(utils.enterTextinAnelemnt(this.txtNotes,"Created in Error", "ResolveAccumulatorReview", "Notes"))
				return utils.clickAnelemnt(this.btnSubmit,"ResolveAccumulatorReview", "Submit");
		return false;
	}
