...
@CucumberOptions(
				...
				features = "PromisedAction11",glue={"stepdefinition"}//,tags={"@node1"}	
				)

public class PromisedActionTest {
	...
	public static void setUp() {
		...
		System.out.println("Test Exceution Report : " + reportLocation + "PromisedAction.html");	
		...
		*/
		...
		ExtentManager.createInstance(reportLocation + "PromisedAction.html");
