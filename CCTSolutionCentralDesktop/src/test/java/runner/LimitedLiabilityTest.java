...
@CucumberOptions(
				...
				features = "LimitedLiability11",glue={"stepdefinition"}//,tags={"@node1"}	
				)

public class LimitedLiabilityTest {
	...
	public static void setUp() {
		...
		*/
		...
		ExtentManager.createInstance(reportLocation + "LimitedLiability.html");
