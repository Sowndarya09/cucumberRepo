...
@CucumberOptions(
				...
				features = "FeatureSmokeTest11",glue={"stepdefinition"}		
				)
...
public class SmokeTest {
	...
	public static void setUp() {
		...
		System.out.println("Test Exceution Report : " + reportLocation + "SmokeTest.html");	
		...
		*/
		...
		ExtentManager.createInstance(reportLocation + "SmokeTest.html");
